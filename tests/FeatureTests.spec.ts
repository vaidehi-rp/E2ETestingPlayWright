...
test('sign in', async ({ page }) => {
  ...
  console.log('Home page loaded succesfully');
...
//Testing Entity Button
  ...
  await expect(page.locator('label').filter({ hasText: 'Entity Name:' })).toBeVisible();await page.getByPlaceholder('Enter the Entity Name').click();
